...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Merault Anthony')
.pauseFor(300)
.typeString('<strong>, WebDesigner</strong> !')
.pauseFor(1000)
.deleteChars(14)
.typeString('<span style="color: #27ae60;"> HTML/CSS/JS</span> !')
.pauseFor(1000)
.deleteChars(14)
.typeString('<span style="color: #7fb2f0;"> WordPress</span> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #00abd8;"> Photoshop</span> !')
.pauseFor(1000)
.deleteChars(12)
.typeString('<span style="color: #000000;"> Photographe</span> !')
.pauseFor(1800)
.start()
...
//---------------- Animation ScrollMagic GSAP section presentation -----------------//
